...
describe("minBy", () => {
  ...
  it("minBy should return the youngest person", () => {
    const returnVal = minBy(people, (person: { age: any; }) => person.age);
  ...
  it("It should find the person with the least alphabetical name (starts with a in this case)", () => {
    const returnVal = minBy(people, (person: { name: any; }) => person.name);
    expect(returnVal).toEqual({
      name: "andrey",
      age: 22,
    });
  ...
  it("should return undefined if no elements in array", () => {
    const returnVal = minBy([] as Person[], (person: { age: any; }) => person.age);
    expect(returnVal).toEqual(undefined);
  });
  it("should work with an array of numbers", () => {
    const returnVal = minBy([2, 1, 3, 4], (num: any) => num);
...
describe("maxBy", () => {
  ...
  it("maxBy should return the oldest person", () => {
    const returnVal = maxBy(people, (person: { age: any; }) => person.age);
    expect(returnVal).toEqual({
      name: "peter",
      age: 30,
    });
  ...
  it("It should find the person with the longest name", () => {
    const returnVal = maxBy(people, (person: { name: string | any[]; }) => person.name.length);
    expect(returnVal).toEqual({
      name: "andrey",
      age: 22,
    });
  ...
  it("should return undefined if no elements in array", () => {
    const returnVal = maxBy([] as Person[], (person: { age: any; }) => person.age);
    expect(returnVal).toEqual(undefined);
  });

  it("should work with an array of numbers", () => {
    const returnVal = maxBy([2, 4, 3, 1], (num: any) => num);
